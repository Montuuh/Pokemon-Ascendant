...
| Game glyphs: type ×18, status ×6, intent ×7, trait ×5, modifier ×2, rarity ×5, medal ×4, action ×10, nav ×8, toolbar ×6 | Authored SVG set (`docs/art/icon-set.md`). The **type** glyphs are the franchise's own emblems as vectors, in the canonical type hues — checked in the v0.5 audit and left alone, because a vector emblem beats a bitmap rip at every UI size | ✅ 74 (`public/art/icons/<family>`) |
