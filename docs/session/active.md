...
**Date:** 2026-09-23 · **Version:** v0.7.4 shipped (*Region 3, Volcanic Highlands*).
...
Aerodactyl, Sabrina/Giovanni/Kiyo/Lorelei (scripted off-type aces). Soul · Earth · Fist · Glacier live (new
...
**Findings to act on:**
- ⚠️ OPEN: Ditto's Transform (a stand-in ships). The Poké Mart shows unmet starters by name (§8.9.2 is Pokédex-only).
...
- Doors in development: Safari, Black Market, the Dojo's extra-moves counter (§2.11.6).
