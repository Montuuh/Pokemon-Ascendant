...
**Date:** 2026-09-21
**Version in progress:** **v0.6.x closed — v0.7 next.** v0.1–v0.6 complete; v0.6.3 is the shipped build.
**Sprint goal:** the pre-v0.7 close-out is done. Today: the Hub redrawn (v0.6.1); **Bond** (§6.8); **catching
as a shown roll** (§2.6.4); **running with a toll** (§3.1.2) (v0.6.2); **the Poké Mart as the shop of the pass**
(v0.6.3). No proposal is with the user.
...
**Blocked on:** nothing.
**Last commit:** see `git log -1` — v0.6.3.
