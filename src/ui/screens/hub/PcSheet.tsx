...
import { UNMET_NAME, type AccountState, speciesMet } from '@/sim';
        ...
        >
          {page && (
            <div className={styles.sheet} data-testid="pc-sheet">
              <Dialog.Title style={{ position: 'absolute', width: 1, height: 1, overflow: 'hidden', clip: 'rect(0 0 0 0)' }}>{speciesMet(account, page.id) ? content.species(page.id).name : UNMET_NAME}</Dialog.Title>
