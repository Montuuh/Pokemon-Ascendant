...
/** The What's new page: the version (and Next count) this browser last read, for the menu's unread dot. */
...
export const ALL_KEYS = [RUN_SAVE_KEY, ACHIEVEMENTS_KEY, ACCOUNT_KEY, SETTINGS_KEY, CHANGELOG_SEEN_KEY] as const;
